...
Thanks to the [original source](https://github.com/stjohnjohnson/smartthings-mqtt-bridge) of this work.  I have modified the server to post additional data to MQTT to feed to telegraf and influx for capturing history.
